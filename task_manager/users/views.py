...
class UserCreateView(SuccessMessageMixin, CreateView):
    ...
    extra_context = {"title": _("Registration"), "button_text": _("Register")}
...
class UserUpdateView(
    ...
    extra_context = {"title": _("Updating user"), "button_text": _("Update")}


class UserDeleteView(
    AuthRequiredMixin, UserPermissionMixin, ProtectedDeleteView
):
    """
